        ...
        <template v-if="images.length > 1">
          <div class="relative aspect-[4/3] rounded-2xl overflow-hidden">
            <NuxtImg
              ...
              fit="cover"
              loading="lazy"
              class="w-full object-cover rounded-lg absolute inset-0 transition-opacity duration-300"
              :class="i === currentIndex ? 'opacity-100' : 'opacity-0'"
            />
          </div>
          <div class="flex items-center space-x-2 absolute bottom-0 max-md:left-0 md:right-0">
            <!--  prev  -->
            <button type="button"
